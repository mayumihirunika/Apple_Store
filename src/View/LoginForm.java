...
public class LoginForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(0, 63, 73));

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 52)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Apple_Store");
        ...
        btnLogin.setBackground(new java.awt.Color(0, 63, 73));
        ...
        btnClear.setBackground(new java.awt.Color(0, 63, 73));
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if(userName.isEmpty() || userPassword.isEmpty()){
            ...
            User user = User.LoginUser(userName, userPassword);
        }
